    ...
    with open(input_file, 'rb') as f:
        ...
        with open(output_file, 'wb') as output_f:
            ...
            for _ in range(num_images):
                ...
                # Convert the image to 14x14 by averaging the corresponding pixels
                ...
                for i in range(new_num_rows):
                    for j in range(new_num_cols):
                        new_image_array[i, j] = np.mean(image_array[i*2:i*2+2, j*2:j*2+2])
...
# Usage example
convert_mnist_images('t10k-images.idx3-ubyte', 't10k-images-14x14.idx3-ubyte')
